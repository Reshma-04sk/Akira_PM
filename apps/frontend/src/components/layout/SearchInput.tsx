  ...
  return (
    ...
    >
      ...
      <input
        ...
        onFocus={handleClick}
        readOnly
        className="w-full pl-9 pr-12 py-1.5 text-xs bg-white/5 border border-white/10 rounded-lg placeholder-muted-foreground/60 hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer"
        aria-label="Search"
      />
